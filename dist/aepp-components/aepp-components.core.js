...
var s=document.querySelector("script[data-namespace='aepp-components']");if(s){publicPath=s.getAttribute('data-path');}
...
})({},"AeppComponents","hydrated","/build/aepp-components/");